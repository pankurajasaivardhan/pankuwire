...
const FEEDS = {
  india: [
    ...
    { name: 'Outlook India',    url: 'https://www.outlookindia.com/rss' },
  ],
  tech: [
  ...
  space: [
    ...
    { name: 'Spaceflight Now2',url: 'https://spaceflight101.com/feed/' },
    { name: 'NASA JPL',       url: 'https://www.jpl.nasa.gov/feeds/news' },
    { name: 'Astronomy Mag',  url: 'https://astronomy.com/rss/news' },
    { name: 'Bad Astronomy',  url: 'https://www.syfy.com/tags/bad-astronomy/rss' },
  ],
  physics: [
